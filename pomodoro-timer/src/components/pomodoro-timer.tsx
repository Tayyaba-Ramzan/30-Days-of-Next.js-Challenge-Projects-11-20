...
export default function PomodoroComponent() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
            <Card className="w-[90%] max-w-md p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
                <div className="flex flex-col items-center justify-center gap-6">
                    <div className="flex items-center justify-center">
                        <Image
                            src={"/image/pomodoro.png"}
                            alt="pomodoro-img"
                            width={300}
                            height={300}
                    ...
                    <h1 className="text-5xl font-bold text-red-600 italic">Pomodoro Timer</h1>
                    <p className="text-2xl text-red-600">A timer for the Pomodoro Technique.</p>
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="text-8xl font-bold text-red-600 italic">
                    ...
                    <div className="p-2">
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button variant="default" className="bg-red-600 text-white">What is Pomodoro Technique?</Button>
                            </AlertDialogTrigger>
