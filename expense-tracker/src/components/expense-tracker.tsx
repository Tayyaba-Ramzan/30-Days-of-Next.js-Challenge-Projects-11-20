...
export default function ExpenseTrackerComponent() {
  ...
  return (
    ...
    <header className="bg-slate-100 text-primary-foreground py-4 px-6 shadow italic font-bold">
      <div className="flex flex-wrap justify-between items-center text-green-800">
          <Image
          src={"/logo.png"}
          alt="logo"
          width={130}
          height={130}
          />
        <h1 className="text-4xl font-bold text-center md:text-left">Expense Tracker</h1>
    ...
    <main className="flex-1 overflow-y-auto p-6">
      <ul className="space-y-4">
        {expenses.map((expense) => (
          <li
            key={expense.id}
            className="bg-card p-4 rounded-lg shadow flex flex-col md:flex-row justify-between items-center"
          >
            <div>
